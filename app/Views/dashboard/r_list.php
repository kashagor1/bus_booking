                            ...
                            foreach ($jsonResult as $data) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . "dashboard/delete_route?id=" . $data['id']; ?>">
                                            <button class="btn btn-sm btn-danger">Delete</button></a>

                                        <a href="<?php echo base_url() . "dashboard/delete_w_route?id=" . $data['route_id']; ?>">
                                            <button class="btn btn-sm btn-danger">Delete Full Route</button></a>
                                    </td>
                                </tr>
                                <?php
                            }
