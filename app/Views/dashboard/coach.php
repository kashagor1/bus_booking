    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <?php endif; ?>
                <form class="row g-3" method="POST" action="<?php echo base_url() ?>dashboard/coach/create">


                    <div class="col-3">
                        <label for="com_id" class="form-label">Compnay ID</label>
                        <input type="text" class="form-control" id="company_id" placeholder="1" name="company_id"
                            value="<?php echo isset($com_id) ? $com_id : "" ?>" required readonly>
                    </div>
                    <div class="col-3">
                        <label for="cc_route_id" class="form-label">Route ID </label>
                        <input type="text" class="form-control" id="cc_route_id" placeholder="1" name="cc_route_id"
                            required>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-3">
                        ...
                        <input type="time" class="form-control" id="departure" placeholder="12" name="departure"
                            required>
                    </div>
                    <div class="col-3">
                        <label for="arrival" class="form-label">Arrival </label>
                        <input type="time" class="form-control" id="arrival" placeholder="12" name="arrival" required>
                    </div>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control" id="total_fare" placeholder="500" name="total_fare"
                            required readonly>
                    </div>
