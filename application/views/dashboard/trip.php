    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <form class="row g-3" method="POST" action="<?php echo base_url()?>dashboard/create_trip">
                    ...
                    <div class="col-6">
                        <label for="coach_type" class="form-label">Trip Date</label>
                        <input type="date" class="form-control" id="coach_type" placeholder="AC/NON-AC/SLEEPER"
